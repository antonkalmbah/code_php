...
<body>
    ...
    <?php 
        ...
        // 
        echo "взамен if...elseif можно использовать конструкция switch\case\break";
        $page = 13;
        switch ($page) {
            case "1":
                echo "Один";
        ...
        //
        echo "Для того, чтобы 'обезвредить' файл от вмешательства личнего кода, стоит пользоваться функцией
        ereg_replace('[^A-Za-z0-9.]', '', $переменная). Эта команда оставляет в строковой переменной $name только символы A–Z, a–z, 
